...
Volksmond is source-available software by **DigiPhyte (Pty) Ltd** (trading as
Business In A Day), South Africa.

The source is published so that anyone can read it and verify that Volksmond runs
entirely on your own machine and never sends your audio or transcripts anywhere.

Volksmond is licensed to the public under the **PolyForm Noncommercial License
1.0.0** (full text below). In short: you may read, run, study, and modify the
source for any **noncommercial** purpose, such as personal use, research, and
education.
