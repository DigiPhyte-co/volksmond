...
window.VM_I18N = {
  af: {
    ...
    "Capturing now on this computer.": "Die klank word nou op hierdie rekenaar vasgevang.",
    ...
    "Capture and recording begin immediately. The transcript fills in from the start once the model is ready, and if you are recording, the audio is saved from the very beginning.":
      "Die klank word dadelik vasgevang. Die transkripsie vul van voor af in sodra die model gereed is, en as jy opneem, word die klank van heel voor af gestoor.",
    ...
    "Opening your microphone and system audio and starting to capture. This is quick.":
      "Maak jou mikrofoon en stelselklank oop en begin vasvang. Dit is vinnig.",
